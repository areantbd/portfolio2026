export const portfolioData = {
  en: {
    ...
    projectList: [
      {
        id: "p1",
        title: "Angular Exercise Collection",
        description:
          "A collection of exercises and small projects developed during my initial learning phase with Angular.",
        tech: ["Angular", "TypeScript", "HTML", "CSS"],
        image:
          "https://ivanrf.netlify.app/static/media/angular1.7c7a0189b70424d52223.png",
      },
      {
        id: "p2",
        title: "Weather App",
        description:
          "A web application that provides real-time weather forecasts for any city in the world using a public API.",
      ...
      },
      {
        ...
        title: "ICash",
        description:
          "A personal finance management application to track income and expenses, with data visualization.",
      ...
      },
      {
        ...
        description:
          "A fun encyclopedia of Rick and Morty characters, locations, and episodes using the Rick and Morty API.",
      ...
      },
      {
        ...
        title: "Shipping Bids",
        description:
          "A platform for bidding on shipping services, connecting carriers with customers needing to transport goods.",
      ...
      },
      {
        ...
        title: "TvTracker",
        description:
          "An application to track TV shows and movies you've watched and discover new ones.",
      ...
      },
      {
        ...
        title: "Scuba Diver",
        description:
          "A blog and information site for scuba diving enthusiasts, with dive logs and location guides.",
        tech: ["React", "Material UI", "Contentful"],
      },
    ],

    certificationList: [
      { name: "Certified JavaScript Developer", authority: "Code Academy" },
      { name: "React - The Complete Guide", authority: "Udemy" },
      { name: "Node.js, Express, MongoDB & More", authority: "Udemy" },
      { name: "Full-Stack Web Development", authority: "FreeCodeCamp" },
    ],
  ...
  es: {
    ...
    projectList: [
      {
        id: "p1",
        title: "Colección de Ejercicios de Angular",
        description:
          "Una colección de ejercicios y pequeños proyectos desarrollados durante mi fase inicial de aprendizaje con Angular.",
        tech: ["Angular", "TypeScript", "HTML", "CSS"],
        image:
          "https://ivanrf.netlify.app/static/media/angular1.7c7a0189b70424d52223.png",
      },
      {
        ...
        description:
          "Una aplicación web que proporciona pronósticos meteorológicos en tiempo real para cualquier ciudad del mundo utilizando una API pública.",
        tech: ["React", "JavaScript", "REST API"],
      },
      {
        id: "p3",
        title: "ICash",
        description:
          "Una aplicación de gestión de finanzas personales para realizar un seguimiento de los ingresos y gastos, con visualización de datos.",
        tech: ["React", "Node.js", "MongoDB", "Express"],
      },
      {
        id: "p4",
        title: "Rick & Morty Pedia",
        description:
          "Una divertida enciclopedia de personajes, lugares y episodios de Rick y Morty utilizando la API de Rick y Morty.",
        tech: ["React", "NextJS", "TypeScript", "GraphQL"],
      },
      {
        id: "p5",
        title: "Shipping Bids",
        description:
          "Una plataforma para pujar por servicios de envío, conectando a transportistas con clientes que necesitan transportar mercancías.",
        tech: ["React", "Node.js", "Socket.io", "PostgreSQL"],
      },
      {
        id: "p6",
        title: "TvTracker",
        description:
          "Una aplicación para realizar un seguimiento de las series y películas que has visto y descubrir nuevas.",
        tech: ["NextJS", "TypeScript", "Firebase"],
      },
      {
        id: "p7",
        title: "Scuba Diver",
        description:
          "Un blog y sitio de información para entusiastas del buceo, con registros de inmersión y guías de lugares.",
        tech: ["React", "Material UI", "Contentful"],
      },
    ],
    ...
    certificationList: [
      {
        name: "Desarrollador JavaScript Certificado",
        authority: "Code Academy",
      },
  ...
  gal: {
    ...
    contact: {
      title: "Contacto",
      description:
        "Sempre estou aberto a discutir novos proxectos, ideas creativas ou oportunidades para ser parte da túa visión.\nNon dubides en contactarme.",
      email: "Envíame un Correo",
      github: "GitHub",
      linkedin: "LinkedIn",
      cv: "Descargar CV",
    ...
    projectList: [
      {
        id: "p1",
        title: "Colección de Exercicios de Angular",
        description:
          "Una colección de ejercicios y pequeños proyectos desarrollados durante mi fase inicial de aprendizaje con Angular.",
        tech: ["Angular", "TypeScript", "HTML", "CSS"],
        image: {
